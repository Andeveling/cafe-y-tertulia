-- RPC get_session_history: devuelve el historial completo de una sesión en un
-- solo round-trip (preguntas, participantes, asignaciones, minijuegos, logros).
-- Reemplaza las 6 queries secuenciales que getSessionHistory hacía desde el
-- módulo TypeScript.
