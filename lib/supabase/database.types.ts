...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      awards: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "awards_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
      ...
      convocatorias: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "convocatorias_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
      ...
      counts: {
        ...
        Relationships: [
          {
            foreignKeyName: "counts_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
      ...
      hearts: {
        Row: {
          ...
          group_id: string
          member_id: string
          phase: Database["public"]["Enums"]["assignment_state"]
          session_id: string
          value: number
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "hearts_assignment_id_fkey"
          ...
          {
            foreignKeyName: "hearts_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "hearts_member_id_fkey"
            columns: ["member_id"]
            isOneToOne: false
            referencedRelation: "members"
            referencedColumns: ["id"]
      ...
      season_recognitions: {
        ...
        Relationships: [
          {
            foreignKeyName: "season_recognitions_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
      ...
      session_categories: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "session_categories_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
      ...
      takes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "takes_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
      ...
      trivia_rounds: {
        ...
        Relationships: [
          {
            foreignKeyName: "trivia_rounds_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
      ...
      trivias: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "trivias_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      cast_heart: {
        Args: {
          p_phase: Database["public"]["Enums"]["assignment_state"]
          p_value: number
      ...
      compute_member_level: {
        Args: { p_group_id?: string; target_member_id: string }
        Returns: Json
      }
      convocar: {
      ...
      draw_lobby_summary: { Args: { target_session_id: string }; Returns: Json }
      ...
      invite_to_group: { Args: { p_group_id: string }; Returns: string }
